...
describe('transactions route', function(){
  ...
  it('Should return get user error when user id is not valid', function (done) {
    chai.request(app)
  ...
  it('Should return get detail error when transaction id is not valid', function(done) {
    chai.request(app)
  ...
  it('Should return edit error when transaction id is not valid', function(done) {
    chai.request(app)
  ...
  it('Should return delete error when transaction id is not valid',function(done){
    chai.request(app)
